...
<link href="<?php echo $_SERVER['REQUEST_URI']?>/../css/installation.css" type="text/css" rel="stylesheet">
   ...
   <div class="content">
	<div class="header">
		...
		<span>Welcome to the ECIT application installer! We need to collect a little information before we can get your application up and running.</span>
	</div>
...
<?php if($flag == 1) { ?>
	...
	<ul class="error-list">
	<h1 class="title">Cannot install ECIT </h1> 
<?php	
