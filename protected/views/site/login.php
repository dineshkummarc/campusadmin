...
<label>Username : admin@ECIT.info</label> 
<label>Password : admin@ECIT.info</label>
</div>

<div class="login-details login-details2">
<span class="user-type">For Employee</span>
<label>Username : employee@ECIT.info</label> 
<label>Password : employee@ECIT.info</label>
</div>


<div class="login-details login-details3">
<span class="user-type">For Student</span>
<label>Username : student@ECIT.info</label>
<label>Password : student@ECIT.info</label>
</div>
-->
