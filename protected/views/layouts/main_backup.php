  ...
  <?php 
	...
	$login_user_name = '';
		...
		<?php echo '<div class="right-menu-link"><ul id ="nav"><li class="welcome">Welcome, '. $login_user_name.'</li>';
			echo '<li>'.CHtml::link('ECIT Support','http://124.125.156.120:8081', array('target'=>'_blank'))."</li>";
...
?>
	...
	<div id="footer">
<div class="powered-by"><span class="powered-text">© Copyright 2016 YOjii Katana. All Rights Reserved.
</span><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/ECIT.png" /> </div>
	</div><!-- footer -->
