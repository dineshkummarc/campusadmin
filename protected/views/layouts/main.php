...
<head>
	...
	<link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl; ?>/images/ECIT_favicon.png" type="image/x-icon" />	
...
<div class="header navbar navbar-inverse navbar-fixed-top">
	...
	?>
		...
		<ul class="dropdown-menu" style="display:none;">
			...
			<li><i class="icon-key"></i><?php echo CHtml::link('Sign Out', 'logout')?></li>
		</ul>
	</li>
	<span style="float: right; margin-top: 42px; background: none repeat scroll 0 0 RED;  padding: 5px; text-decoration: blink; border-radius: 2px;"><?php echo CHtml::link('Join Developer', 'http://www.facebook.com/groups/futuredeveloper', array('style'=>'text-decoration: none; color: #FFF; font-size: 17px;  font-weight: 700;', 'target'=>'_blank')); ?></span>
      </div>
...
<ul id="accordion" class="page-sidebar-menu">
	<?php if(Yii::app()->user->checkAccess('Menu Options')) { ?>
	<i class="icon-cog"></i><li>Menu Options <i class="icon-angle-down"></i> </li>
	<ul>
	...
	<ul>
		<li><?php echo CHtml::link('Enrolled Students', array('/student/studentTransaction/admin'), array('class'=>'changeForm')); ?></li>
	</ul>
	<?php } ?>
	...
	<?php } ?>
	<?php if(Yii::app()->user->checkAccess('Cabinet Document')) { ?>
	...
	<?php } ?>
	<?php if(Yii::app()->user->checkAccess('Print')) { ?>
	...
	<i class="icon-inr"></i><li><?php echo CHtml::link('Tuition Fees', array('/student/studentPaidFeesDetails/admin'), array('class'=>'changeForm', 'style'=>'padding:0; color: #FFF;')); ?> </li><ul><li></li></ul>
	<?php } ?>

</ul>

<div class="product-logo">
<?php echo CHtml::link(CHtml::image(Yii::app()->baseUrl.'/images/product.png', 'Product'), 'http://www.facebook.com/davaocapstone', array('target'=>'_blank')); ?>
...
<div class="footer">
	© 2016 design by <a href="http://www.facebook.com/davaocapstone">Davao Capstone (YOjii Katana)</a> | <a href="http://www.facebook.com/groups/futuredeveloper">ITFD</a>, All right Reserved.
</div>
